            ...
            <View style={styles.topView}>
              ...
              <View style={{ top: -30, marginHorizontal: 20 }}>
                <Text style={styles.modalText1}>
                  {/* {console.log("Sm here",isReverification)} */}
                  {isVerifcationPopUp
                ...
                >
                  {isVerifcationPopUp
                    ? "We are not able to verify your face. Please try again"
                    : "We have failed to recoginize your face and click to submit the report "}
                </Text>
