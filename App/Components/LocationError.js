            ...
            <View style={styles.topView}>
              <View style={styles.roundedView}>
                <Image
                  source={
                    isLocationError
                      ? Images.modalLocationImage //This is to add hte image into the Popupbox in the circle Box//
                      : null
                  }
              ...
              <View style={{ top: -30, marginHorizontal: 20 }}>
                <Text style={styles.modalText1}>
                  {" "}
                    {isLocationError ? (<> {isLocationverification ? "Location Fetching Error" : " Location Fetching Failure" }</>): null}

                  {/* {isLocationError
                    ? "Location Fetching Error"
                    : "Lcation Fetching Error"} */}
                </Text>
                <Text
                  style={[
                    styles.modalText2,
                ...
                >
                     {isLocationError?(<>{isLocationverification?"We are not able to fetch your location, Kindly please refresh the page":"You are Exceeded the refresh try Kindly please report the Location Failure Problem"}</>): null}
                ...
                {isLocationverification ? (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Text style={styles.checkInText}>Refresh</Text>
                      </LinearGradient>
                    </TouchableOpacity>
                  </View>
                ) : (
                  ...
                  >
                    ...
                    >
                      <LinearGradient
                        ...
                        style={styles.checkInButton}
                      >
                        <Text style={styles.checkInText}>Submit the Problem</Text>
                      </LinearGradient>
                    </TouchableOpacity>
                  </View>
                )}
