...
The driving goal of the architecture of the application is separation of concerns. Namely:
...
- [`App/Assets`](App/Assets): contains images and locales
...
The application will follow new React-Native releases as soon as libraries and tools used here are compatible.
